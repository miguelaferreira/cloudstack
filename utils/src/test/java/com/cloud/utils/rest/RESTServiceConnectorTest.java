...
public class RESTServiceConnectorTest {
    ...
    public void testExecuteUpdateObject() throws Exception {
        ...
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestPayloadMatcher.hasPayload(newObjectJson), any(HttpClientContext.class));
    }
    ...
    public void testExecuteUpdateObjectWithParameters() throws Exception {
        ...
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestMethodMatcher.hasMethod("PUT"), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestPayloadMatcher.hasPayload(newObjectJson), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestQueryMatcher.hasQuery("agr2=val2&agr1=val1"), any(HttpClientContext.class));
    }
