...
public class NiciraNvpApiTest {
    ...
    public void testFindSecurityProfile() throws Exception {
        ...
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestMethodMatcher.hasMethod("GET"), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestQueryMatcher.hasQuery("fields=*"), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestPathMatcher.hasPath(NiciraConstants.SEC_PROFILE_URI_PREFIX), any(HttpClientContext.class));
    }
    ...
    public void testFindSecurityProfileByUuid() throws Exception {
        ...
        verify(response, times(1)).close();
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestMethodMatcher.hasMethod("GET"), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestQueryMatcher.containsSubQuery("uuid=" + UUID), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestQueryMatcher.containsSubQuery("fields=*"), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestPathMatcher.hasPath(NiciraConstants.SEC_PROFILE_URI_PREFIX), any(HttpClientContext.class));
    }
    ...
    public void testCreateSecurityProfile() throws Exception {
        ...
        verify(response, times(1)).close();
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestMethodMatcher.hasMethod("POST"), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestPathMatcher.hasPath(NiciraConstants.SEC_PROFILE_URI_PREFIX), any(HttpClientContext.class));
    }
    ...
    public void testUpdateSecurityProfile() throws Exception {
        ...
        verify(response, times(1)).close();
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestMethodMatcher.hasMethod("PUT"), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestPathMatcher.hasPath(NiciraConstants.SEC_PROFILE_URI_PREFIX + "/" + UUID), any(HttpClientContext.class));
    }
    ...
    public void testDeleteSecurityProfile() throws Exception {
        ...
        verify(response, times(1)).close();
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestMethodMatcher.hasMethod("DELETE"), any(HttpClientContext.class));
        verify(httpClient).execute(any(HttpHost.class), HttpUriRequestPathMatcher.hasPath(NiciraConstants.SEC_PROFILE_URI_PREFIX + "/" + UUID), any(HttpClientContext.class));
    }
